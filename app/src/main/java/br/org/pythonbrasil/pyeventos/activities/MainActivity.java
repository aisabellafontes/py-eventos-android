package br.org.pythonbrasil.pyeventos.activities;
...
import br.org.pythonbrasil.pyeventos.BuildConfig;
import br.org.pythonbrasil.pyeventos.R;
import br.org.pythonbrasil.pyeventos.api.PythonBrasilApi;
import br.org.pythonbrasil.pyeventos.db.DatabaseManager;
import br.org.pythonbrasil.pyeventos.fragments.BookmarksListFragment;
import br.org.pythonbrasil.pyeventos.fragments.LiveFragment;
import br.org.pythonbrasil.pyeventos.fragments.MapFragment;
import br.org.pythonbrasil.pyeventos.fragments.PersonsListFragment;
import br.org.pythonbrasil.pyeventos.fragments.TracksFragment;
import br.org.pythonbrasil.pyeventos.widgets.AdapterLinearLayout;
...
public class MainActivity extends AppCompatActivity implements Handler.Callback {
	...
	private final BroadcastReceiver scheduleDownloadProgressReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			progressBar.setProgress(intent.getIntExtra(PythonBrasilApi.EXTRA_PROGRESS, 0));
		}
	};
	...
	private final BroadcastReceiver scheduleDownloadResultReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			int result = intent.getIntExtra(PythonBrasilApi.EXTRA_RESULT, PythonBrasilApi.RESULT_ERROR);
			String message;
			switch (result) {
				case PythonBrasilApi.RESULT_ERROR:
					message = getString(R.string.schedule_loading_error);
					break;
				case PythonBrasilApi.RESULT_UP_TO_DATE:
	...
	protected void onStart() {
		...
		lbm.registerReceiver(scheduleDownloadProgressReceiver, new IntentFilter(PythonBrasilApi.ACTION_DOWNLOAD_SCHEDULE_PROGRESS));
		lbm.registerReceiver(scheduleDownloadResultReceiver, new IntentFilter(PythonBrasilApi.ACTION_DOWNLOAD_SCHEDULE_RESULT));
	...
	private static class DownloadScheduleAsyncTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... args) {
			PythonBrasilApi.downloadSchedule(appContext);
			return null;
		}
	}
