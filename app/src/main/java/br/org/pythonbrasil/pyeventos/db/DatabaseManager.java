package br.org.pythonbrasil.pyeventos.db;
...
import br.org.pythonbrasil.pyeventos.model.Event;
import br.org.pythonbrasil.pyeventos.model.Link;
import br.org.pythonbrasil.pyeventos.model.Person;
...
public class DatabaseManager {
	...
	public static final String ACTION_SCHEDULE_REFRESHED = "be.digitalia.br.org.pythonbrasil.pyeventos.action.SCHEDULE_REFRESHED";
	public static final String ACTION_ADD_BOOKMARK = "be.digitalia.br.org.pythonbrasil.pyeventos.action.ADD_BOOKMARK";
	public static final String EXTRA_EVENT_ID = "event_id";
	public static final String EXTRA_EVENT_START_TIME = "event_start";
	public static final String ACTION_REMOVE_BOOKMARKS = "be.digitalia.br.org.pythonbrasil.pyeventos.action.REMOVE_BOOKMARKS";
	public static final String EXTRA_EVENT_IDS = "event_ids";

	private static final Uri URI_TRACKS = Uri.parse("sqlite://be.digitalia.br.org.pythonbrasil.pyeventos/tracks");
	private static final Uri URI_EVENTS = Uri.parse("sqlite://be.digitalia.br.org.pythonbrasil.pyeventos/events");
	...
	public int getYear() {
		...
		Calendar cal = Calendar.getInstance(DateUtils.getBrasiliaTimeZone(), Locale.US);
